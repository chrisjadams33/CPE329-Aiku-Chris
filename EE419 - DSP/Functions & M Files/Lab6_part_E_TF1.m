...
[Ak, Bk] = show_filter_responses_pz([0.95*exp(j*pi*7.5/180), 0.95*exp(-j*pi*7.5/180)],[1*exp(j*pi*7.5/180), 1*exp(-j*pi*7.5/180)], 0.9037008, 48e3,100e3, 40, 1);
...
[poles, zeros, HF1] = show_filter_response(unscaled_Ak, unscaled_Bk, 48e3, 1000, 40, 1);
