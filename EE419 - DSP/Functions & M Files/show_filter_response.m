function [poles, zeros, HF, Fd, hn, n] = show_filter_response(Ak, Bk, fsample, num_of_f_points, num_of_n_points, figure_num)
% This function takes multiple arguments: the Ak and Bk coefficients of the
% difference equation, the sampling frequency, the number of f and n
